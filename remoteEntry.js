...
/* harmony import */var _home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0__);
...
if (__webpack_require__.initializeSharingData || __webpack_require__.initializeExposesData) {
    ...
    early(__webpack_require__, "federation", ()=>(_home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default()));
    ...
    override(__webpack_require__, "S", (_home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().bundlerRuntime.S));
    if ((_home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().attachShareScopeMap)) _home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().attachShareScopeMap(__webpack_require__);
    override(__webpack_require__.f, "remotes", (chunkId, promises)=>_home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().bundlerRuntime.remotes({
            chunkId,
            promises,
    ...
    override(__webpack_require__.f, "consumes", (chunkId, promises)=>_home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().bundlerRuntime.consumes({
            chunkId,
            promises,
    ...
    override(__webpack_require__, "I", (name, initScope)=>_home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().bundlerRuntime.I({
            shareScopeName: name,
            initScope,
    ...
    override(__webpack_require__, "initContainer", (shareScope, initScope, remoteEntryInitOptions)=>_home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().bundlerRuntime.initContainerEntry({
            shareScope,
            initScope,
            remoteEntryInitOptions,
    ...
    (_home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().instance) = _home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().runtime.init((_home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().initOptions));
    if ((_m = __webpack_require__.consumesLoadingData) === null || _m === void 0 ? void 0 : _m.initialConsumes) _home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().bundlerRuntime.installInitialConsumes({
        webpackRequire: __webpack_require__,
        installedModules: consumesLoadinginstalledModules,
        initialConsumes: __webpack_require__.consumesLoadingData.initialConsumes,
        moduleToHandlerMapping: (_home_runner_work_webdeck_stocks_webdeck_stocks_node_modules_rspack_core_node_modules_module_federation_webpack_bundler_runtime_dist_index_cjs_js__WEBPACK_IMPORTED_MODULE_0___default().consumesLoadingModuleToHandlerMapping)
    });
}
}),
...
!function() {
var map = {"358@./Plugin": ["132", "990"], "537@0:24": ["132", "990"], "697@": ["512"], "698@": ["987"], "821@": ["987", "132"], "957@": ["512"]};
...
__webpack_require__.consumesLoadingData = { chunkMapping: {"990":[],"132":["697"],"512":[],"987":[]}, moduleIdToConsumeDataMapping: { "697": { shareScope: "default", shareKey: "react", import: "react", requiredVersion: "^18.2.0", strictVersion: false, singleton: true, eager: false, fallback: function() { return __webpack_require__.el("697@").then(function() { return function() { return __webpack_require__(/*! react */"294"); }; }); } } }, initialConsumes: [] };
...
var __webpack_exports__ = __webpack_require__("358");self.webdeck_stocks = __webpack_exports__;
